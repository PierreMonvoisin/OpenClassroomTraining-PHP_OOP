  ...
  <div class="jumbotron p-5">
                ...
                <div class="list-group-item w-100">
                  <div class="d-flex col-12">
                    ...
                    <?php if ($user->type() === 'wizard'){ ?>
                      <form class="ml-auto d-flex" action="#" method="post">
                        <input type="hidden" name="userToHitId" value="<?= $users['id'] ?>">
                        <input class="btn btn-info font-weight-bold m-auto" type="submit" name="specialHit" value="special hit !">
                      </form>
                    <?php } ?>
                  </div>
                </div>
    ...
    <?php } else { ?>
      ...
      <form class="w-100 p-3" action="#" method="post">
        ...
        <div class="col-6 flex-wrap collapse mt-2" id="selection">
          ...
          <input type="submit" name="create" class="btn btn-block btn-success mt-2" value="Validate your type">
        </div>
      </form>
    <?php } ?>
  </div>
